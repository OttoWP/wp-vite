...
describe('Test expected generated build files & contents', () => {
  ...
  beforeAll(() => {
    if (isDist) {
      execSync('yarn test-build-dist', {cwd: rootDir, stdio: 'inherit'});
      console.log('Testing distribution files')
    } else {
      execSync('yarn test-build', {cwd: rootDir, stdio: 'inherit'});
